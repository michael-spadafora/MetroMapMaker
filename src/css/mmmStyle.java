...
public class mmmStyle {
    ...
    public static final String UNBORDERED_PANE = "unbordered_pane";
    public static final String SIDE_PANE = "side_pane";
    public static final String VERTICAL_SIDE_PANE = "vertical_side_pane";
    public static final String COMBO_BOX = "combo_box";
    public static final String SLIDER = "slider";
    public static final String COLOR_PICKER = "color_picker";
    public static final String FULL_WIDTH_SIDE_BUTTON = "full_side_button";
